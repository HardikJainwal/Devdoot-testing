...
export default function DermaCare(){
            ...
            <section id="home" className="fade-in text-center">
                <div className="bg-white rounded-2xl p-8 md:p-12 shadow-xl">
                    ...
                    <div className="flex justify-center gap-4">
                        ...
                        <a onClick={()=>{ scrollToSection(expertsRef)}} className="bg-primary-light text-primary font-bold py-3 px-8 rounded-full hover:bg-primary/20 transition-colors cursor-pointer">Book a Consultation</a>
            ...
            <section id="how-it-works" className="fade-in text-center" style={{animationDelay: "0.2s"}}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="bg-white p-6 rounded-xl shadow-lg transform hover:-translate-y-2 transition-transform duration-300">
                        <div className="bg-primary-light text-primary w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4"><i className="fa-solid fa-camera-retro text-2xl"></i></div>
                    ...
                    {/* Step 2 */}
                    <div className="bg-white p-6 rounded-xl shadow-lg transform hover:-translate-y-2 transition-transform duration-300">
                        <div className="bg-primary-light text-primary w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4"><i className="fa-solid fa-file-waveform text-2xl"></i></div>
                    ...
                    {/* Step 3 */}
                    <div className="bg-white p-6 rounded-xl shadow-lg transform hover:-translate-y-2 transition-transform duration-300">
                        <div className="bg-primary-light text-primary w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4"><i className="fa-solid fa-user-doctor text-2xl"></i></div>
    ...
    ================================================================== */}
            <section id="ai-scan" ref={aiScanRef} className="fade-in text-center bg-white p-8 md:p-12 rounded-2xl shadow-xl" style={{animationDelay: "0.4s"}}>
                <i className="fa-solid fa-robot text-6xl text-primary mb-4"></i>
                ...
                <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center bg-gray-50 max-w-lg mx-auto">
                    ...
                    <input type="file" id="skinImageInput" className="hidden" accept="image/*" />
                    <button id="scanSkinBtn" className="mt-4 w-full md:w-auto bg-accent text-white font-bold py-3 px-8 rounded-lg hover:bg-accent-hover transition-transform transform hover:scale-105">
                        <i className="fa-solid fa-camera mr-2"></i>Scan Your Skin Now
                    </button>
                </div>
            </section>
                    ...
                    <div>
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <select id="skinType" className="w-full p-3 border border-gray-300 rounded-md text-dark">
                            ...
                            <div>
                                ...
                                <select id="mainConcern" className="w-full p-3 border border-gray-300 rounded-md text-dark">
                                    <option>Acne</option><option>Aging</option><option>Pigmentation</option><option>Dullness</option><option>Redness</option>
                                </select>
                            </div>
                            <button id="submitPlanRequest" className="w-full bg-white text-primary font-bold py-3 px-4 rounded-lg flex items-center justify-center gap-2 hover:bg-gray-100 transition-colors">
            ...
            <section id="experts" ref={expertsRef} className="fade-in" style={{animationDelay: "0.8s"}}>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div className="doctor-card bg-white rounded-xl shadow-lg p-6 text-center group transform hover:-translate-y-2 transition-transform duration-300">
                        ...
                        <button className="w-full bg-primary text-white font-bold py-3 px-4 rounded-lg group-hover:bg-accent transition-colors duration-300">Book Video Consult</button>
                    </div>
                    {/* Doctor Card 2 */}
                    <div className="doctor-card bg-white rounded-xl shadow-lg p-6 text-center group transform hover:-translate-y-2 transition-transform duration-300">
                        <div className="relative inline-block">
            ...
            <section id="testimonials" className="fade-in max-w-4xl mx-auto text-center" style={{animationDelay: '1.0s'}}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="bg-white rounded-lg shadow-lg p-8">
                        <div className="text-primary text-3xl mb-4"><i className="fa-solid fa-quote-left"></i></div>
