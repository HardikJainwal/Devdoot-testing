...
const services = [
  { title: "Care Match", icon: Heart, color: "from-pink-500 to-rose-500", bgColor: "bg-pink-50" },
  { title: "Coach Match", icon: Users, color: "from-blue-500 to-cyan-500", bgColor: "bg-blue-50" },
  { title: "Health Buddy", icon: Activity, color: "from-green-500 to-emerald-500", bgColor: "bg-green-50" },
  { title: "Immuni Care", icon: Shield, color: "from-purple-500 to-violet-500", bgColor: "bg-purple-50" },
  { title: "MedEquip", icon: Stethoscope, color: "from-indigo-500 to-blue-500", bgColor: "bg-indigo-50" },
  { title: "PetWell", icon: PawPrint, color: "from-orange-500 to-amber-500", bgColor: "bg-orange-50" },
  { title: "AyurCare", icon: Leaf, color: "from-teal-500 to-green-500", bgColor: "bg-teal-50" },
  { title: "Mental Health", icon: Brain, color: "from-rose-500 to-pink-500", bgColor: "bg-rose-50" },
  { title: "AidFirst", icon: Cross, color: "from-red-500 to-rose-500", bgColor: "bg-red-50" },
  { title: "SpeciFind", icon: Search, color: "from-slate-500 to-gray-500", bgColor: "bg-slate-50" },
  { title: "BloodMate", icon: Droplets, color: "from-red-600 to-red-500", bgColor: "bg-red-50" },
  { title: "ReproWell", icon: Heart, color: "from-pink-600 to-rose-500", bgColor: "bg-pink-50" },
  { title: "ChildCare++", icon: Baby, color: "from-yellow-500 to-orange-500", bgColor: "bg-yellow-50" },
  { title: "NutritiGuide", icon: Utensils, color: "from-lime-500 to-green-500", bgColor: "bg-lime-50" },
  { title: "DermaCare", icon: Sparkles, color: "from-violet-500 to-purple-500", bgColor: "bg-violet-50" },
];
            ...
            return (
              ...
              >
                ...
                <div className="relative p-6 flex flex-col items-center text-center">
                  {/* Icon container */}
                  <div className={`p-4 rounded-2xl bg-gradient-to-br ${service.color} shadow-lg mb-4 group-hover:scale-110 transition-transform duration-300`}>
