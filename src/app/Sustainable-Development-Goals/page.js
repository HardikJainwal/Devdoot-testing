        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12">
          {goals.map((goal, index) => (
            ...
            >
              ...
              <div className={`absolute inset-0 bg-gradient-to-r ${goal.gradient} opacity-0 group-hover:opacity-10 transition-opacity duration-300 rounded-2xl`}></div>
              ...
              <div className="relative p-8">
                ...
                <div className="flex justify-center mb-6">
                  <div className="relative">
                    <div className={`absolute inset-0 bg-gradient-to-r ${goal.gradient} rounded-full blur-xl opacity-30 scale-150 group-hover:opacity-50 transition-opacity duration-300`}></div>
                ...
                <div className="flex justify-center mb-4">
                  <span className={`inline-block bg-gradient-to-r ${goal.gradient}  text-white text-sm px-4 py-2 rounded-full `}>
                    SDG {goal.id}
                  </span>
                </div>
                ...
                <div className={`w-16 h-1 bg-gradient-to-r ${goal.gradient} mx-auto mt-6 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300`}></div>
              </div>
            </div>
          ))}
        </div>
